...
describe("Testing favorite book list", () => {
  beforeEach(() => {
    cy.visit("/booksNode");
    cy.login("bropet@mail.ru","123");
  });
  ...
  it("Add new favorite book",() => {
    ...
    cy.typing("#description.form-control",
    ...
    cy.get("h4").click();
    cy.contains(".card-text", "Фёдор Михайлович Достоевский").should("be.visible");
});

it("Should delete from favorite", () => {
  cy.get("h4").click();
  cy.get(".card-footer > .btn").click();
  cy.contains('.btn > a', "Please add some book to favorit on home page!").should("be.visible");
});
